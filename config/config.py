...
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5642402307").split())
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TEAMSTD09/LegendMusicbot",
)
...
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/b259fe4f68662d9f0a398.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://te.legra.ph/file/b259fe4f68662d9f0a398.jpg",
)
